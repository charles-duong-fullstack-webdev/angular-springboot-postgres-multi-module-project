...
Insert into AIRCRAFT_TYPE (AIRCRAFT_TYPE_ID,SHORT_NAME,LONG_NAME,DESCRIPTION,NOTES) values (NEXTVAL('AIRCRTYP_PK_SEQ'),'HPSELA','High-Performance Single-Engine Land Airplane','An airplane with an engine > 200 horsepower.', 'Notes Notes Notes');
